package com.hubspot.httpql.lib.doc;

import com.hubspot.httpql.lib.impl.QueryParser;
import com.hubspot.httpql.lib.impl.UriParamParser;
...
public class ApiDefinition {
  ...
  public ApiDefinition(QueryParser<?> queryParser) {
    ...
    for (BoundFilterEntry<?> filterEntry : queryParser.getMeta().getFilterTable().rowKeySet()) {
      ...
      for (String filterOp : UriParamParser.getFilterImpl(filterEntry.getFilter().getClass()).names()) {
