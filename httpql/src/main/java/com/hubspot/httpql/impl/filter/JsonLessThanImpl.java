...
public class JsonLessThanImpl extends JsonFilterBase implements FilterImpl {
  ...
  public Set<Class<? extends Filter>> getAnnotationClasses() {
    return ImmutableSet.of(
      JsonLessThan.class,
      com.hubspot.httpql.filter.JsonLessThan.class
    );
  }
}
